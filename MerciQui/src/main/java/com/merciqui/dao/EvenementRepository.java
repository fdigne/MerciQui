...
public interface EvenementRepository extends JpaRepository<Evenement, String> {
	...
	int getNbreDatesByComedien(@Param("x")Long id3T);
	...
	Collection<String> getListEvenementsParComedien(@Param("x")Long id3T);
	...
	Collection<BigInteger> getListSpectacleParComedienParPeriodeParCompagnie(@Param("x")Long id3t, @Param("y")Date dateDebut,@Param("z")Date dateFin, @Param("w")String compagnie);
	...
	int getNbreDatesParComedienParSpectacleParPeriode(@Param("x")Long id3t, @Param("w")Long idSpectacle, @Param("y")Date dateDebutFiltre,
	...
	Collection<BigInteger> getListSpectacleParComedienParPeriode(@Param("x")Long id3t, @Param("y")Date dateDebutFiltre, @Param("z")Date dateFinFiltre);
	...
	int existEvenementFuturParComedien(@Param("x")Long id3t);
